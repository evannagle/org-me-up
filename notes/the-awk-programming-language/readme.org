...
** ASM -- toy assembler and interpreter
   :PROPERTIES:
   :header-args: :in-file data/asm/asm

#+BEGIN_SRC sh :results scalar
awk -f data/asm/asm data/asm/sum-nums.as data/asm/numbers.txt
#+END_SRC
...
#+BEGIN_SRC sh :results scalar
awk -f data/graph/graph.awk data/graph/deaths.graph
#+END_SRC
...
#+BEGIN_SRC sh
scmd=$(awk -f data/sortgen/sortgen.awk data/sortgen/sort.txt)
#echo $scmd

cat data/sortgen/sortable.txt | eval $scmd
#+END_SRC

#+RESULTS:
| Mike   | Aber  | 22 | M | Sober   | 1000 |
| Joon   | Jark  | 35 | F | Sober   | 2000 |
| Evan   | Nagle | 35 | M | Drunk   | 3000 |
| Jaimie | Nagle | 34 | F | Sober   | 3000 |
| Evan   | Nagle | 24 | M | Sober   | 3100 |
| Leroy  | Nagle |  6 | M | Dog     |  200 |
| Jonie  | Nagle |  2 | F | Toddler | 4000 |
| Elvis  | Nagle |  1 | M | Baby    | 4000 |
| Mike   | Zibra |  6 | M | Dog     |  200 |
