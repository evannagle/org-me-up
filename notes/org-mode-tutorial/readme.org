...
* Episode 2, Snippet 2: Agenda View
  :PROPERTIES:
...
* Episode 2, Snippet 3: Customized Agenda Views 
  :PROPERTIES:
...
* Episode 2, Snippet 4: Drawers, Logging, and Quick Notes 
  :PROPERTIES:
...
* Episode 3, Snippet 1: Automatic Logging of Status Changing
  :PROPERTIES:
...
*** DONE Item 2
    ...
    :END:
*** TODO Item 3
* Episode 3, Snippet 2: Splitting your system up into several files
  :PROPERTIES:
...
* Episode 3, Snippet 3: The first capture template
  :PROPERTIES:
  :VIDEO:    [[https://www.youtube.com/watch?v=ECWtf6mAi9k][Episode 3, Snippet 2]]
  :END:
